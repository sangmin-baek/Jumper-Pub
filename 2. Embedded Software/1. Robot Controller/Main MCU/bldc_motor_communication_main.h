...
#ifndef INC_BLDC_MOTOR_COMMUNICATION_MAIN_H_
#define INC_BLDC_MOTOR_COMMUNICATION_MAIN_H_
...
typedef struct{
	volatile float uSD_data[BLDC_SPI_DATA_NUM];
} _BLDC_DATA_uSD;

extern _BLDC_CMD _bldc_cmd;
extern _BLDC_DATA _bldc_data;
extern _BLDC_DATA_uSD _bldc_data_uSD;
...
#endif /* INC_BLDC_MOTOR_COMMUNICATION_MAIN_H_ */
